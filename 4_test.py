...
class DomiciliarioApp:
    def __init__(self, root):
        ...
        ttk.Label(registro_label_frame, text="Nombre completo:").grid(row=0, column=0, sticky="w", padx=5, pady=5)
        ...
        ttk.Button(self.registro_frame, text="Registrar Domiciliario", command=self.registrar_domiciliario).pack(pady=10)
        ...
        self.calificacion_scale = ttk.Scale(calificacion_label_frame, from_=1, to=5, orient=tk.HORIZONTAL)
        self.calificacion_scale.pack()
        ttk.Label(calificacion_label_frame, text="Calificación").pack()

        ttk.Button(calificacion_label_frame, text="Calificar", command=self.calificar_domiciliario).pack(pady=10)
